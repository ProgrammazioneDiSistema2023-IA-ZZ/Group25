...
pub fn modify_weight_based_on_error(original_value: &mut f64, error_type: &ErrorType) {
    match error_type {
...
pub fn stuck_at_x(value: &mut f64, index: usize, new_bit: u8) {
